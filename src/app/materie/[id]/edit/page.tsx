...
export default function EditMateria() {
    ...
    useEffect(() => {
        ...
        setFormData({
            titolo: materia.titolo,
            prof: materia.insegnante,
            ore: materia.ore.toString(),
            libro: materia.libro || '',
            argomenti: materia.argomenti.join(', '),
            link: materia.links?.[0] || '',
        });
    }, [id]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const nuoveMaterie = materieEsistenti.map(m =>
                m.id === id ? materiaAggiornata : m
            );
